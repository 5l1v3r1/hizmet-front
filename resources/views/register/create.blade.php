            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                        <form class="form clearfix" role="form" method="POST" action="{{ url('/register') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="repeat_password" class="col-form-label required">Üye Tipi</label>
                                <input name="type" type="checkbox"  id="type1" value="1" /> <label for="type1" class="col-form-label">Hizmet Alan</label>
                                <input name="type" type="checkbox"  id="type2" value="2" /> <label for="type2" class="col-form-label">Hizmet Veren</label>
                            </div>
