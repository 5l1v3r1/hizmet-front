                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td bgcolor="#e9703e" style="padding: 12px 18px 12px 18px; -webkit-border-radius:8px; border-radius:8px" align="center">
                                                                                <a href="{{ $actionUrl }}" target="_blank" style="{{ $fontFamily }} font-size: 16px; font-weight: normal; color: #ffffff; text-decoration: none; display: inline-block;">{{ $actionText }}</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                        ...
                                        <!-- Salutation -->
                                        <p style="{{ $style['paragraph'] }}">
                                            {{ trans('global.regards')}}, {{ config('app.name') }}
                                        </p>
                                        ...
                                        @if (isset($actionText))
                                            <table style="{{ $style['body_sub'] }}">
                                                <tr>
                                                    <td style="{{ $fontFamily }}">
                                                        <p style="{{ $style['paragraph-sub'] }} margin-bottom: 10px;">
                                                           *** {{ trans('global.reset_password_email_warning') }}
                                                        </p>

                                                        <p style="{{ $style['paragraph-sub'] }} margin-bottom: 0px;">
                                                            {{ trans('global.reset_password_mail_helper') }}
                                                        </p>
