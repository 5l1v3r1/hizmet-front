                    ...
                    <div class="col-md-3">
                        <nav class="nav flex-column side-nav">
                            ...
                            @if(Auth::user()->type==1)
                                ...
                                <a class="nav-link icon active" href="./ilanlarim">
                            ...
                            <div class="item">
                                ...
                                <div class="wrapper">
                                    ...
                                    <div class="admin-controls">
                                        <a href="/ilan-duzenle/{{$one->id}}">
                                            <i class="fa fa-pencil"></i>Düzenle
                                        </a>
                                        <a href="/ilan-gizle/{{$one->id}}/{{$one->visibled}}" class="ad-hide">
                                            <i class="fa fa-eye-slash"></i>
                                            @if($one->visibled ==0) Gizle @else Göster @endif
                                        </a>
                                        <a href="/ilan-sil/{{$one->id}}" class="ad-remove">
