                ...
                <div class="items list grid-xl-4-items grid-lg-3-items grid-md-2-items">
                    <div class="item">
                        ...
                        <div class="wrapper">
                            ...
                            <!--end description-->
                            @if($one->status==1)
                            <a href="/teklif-onay/{{$one->bid}}" class="detail text-caps underline" style="right: 8rem;">Onayla</a>
                            <a href="/teklif-red/{{$one->bid}}" class="detail text-caps underline">Sil</a>
                            @elseif($one->status==2)
                                <a href="/teklif-geri-al/{{$one->bid}}" class="detail text-caps underline">iptal</a>
                            @endif
                        </div>
                    </div>
                </div>
